...
class generate_tool:
    ...
    def get_rank_plate_id(rank_plate_name):
        with open("./assets/data/id_to_plate_name.json", "r", encoding="utf-8") as f:
    ...
    def draw_number(dx_rating, base):
        ...
        for file_name in rating_list:
            num_image = Image.open(f"./assets/img/mai/b50/numbers/{file_name}.png")
    ...
    def draw_bests(base, data, type):
        ...
        pic_y = 624
        _range = 15
        FotB_12 = ImageFont.truetype("./assets/font/FOT-RodinNTLGPro-B.otf", size=12)
        FotB_20 = ImageFont.truetype("./assets/font/FOT-RodinNTLGPro-EB.otf", size=20)
        FotEB_14 = ImageFont.truetype("./assets/font/FOT-RodinNTLGPro-B.otf", size=14)
        HanSans35_16 = ImageFont.truetype("./assets/font/SourceHanSans_35.otf", size=16)
        if type == 35:
            _range = 35
            pic_y = 1034
        for count in range(_range):
            ...
            try:
                ...
                base = generate_tool.simple_draw(base, f"./assets/img/mai/b50/diff/mai-frame-{song_level}.png",
                                                 [282, 120], [19 + index * 280, pic_y])
                base = generate_tool.simple_draw(base, f"./assets/cover/mai/UI_Jacket_{song_id_6}.png", [60, 60],
                                                 [36 + index * 280, pic_y + 17])
                if song_info["type"] == "dx":
                    base = generate_tool.simple_draw(base, "./assets/img/mai/b50/UI_RSL_MBase_mode_DX.png", [19, 9],
                                                     [38 + index * 280, pic_y + 66])
                    song_id += 10000
                else:
                    base = generate_tool.simple_draw(base, "./assets/img/mai/b50/UI_RSL_MBase_mode_SD.png", [19, 9],
                                                     [38 + index * 280, pic_y + 66])
                ...
                font_left = generate_tool.right_font(284 + index * 280, draw_info,
                                                     str(song_dx_score) + " / " + str(song_max_dx_score), FotB_12)
                draw_info.text([font_left, pic_y + 41], str(song_dx_score) + " / " + str(song_max_dx_score), text_color,
                               FotB_12)
                ...
                base = generate_tool.simple_draw(base, f"./assets/img/mai/b50/achi/UI_TTR_Rank_{song_rate}.png",
                                                 [56, 25], [234 + index * 280, pic_y + 57])
                dx_star = generate_tool.return_dx_star(song_dx_score, song_max_dx_score)
                base = generate_tool.simple_draw(base, f"./assets/img/mai/b50/star/dxstar_{dx_star}.png", [20, 20],
                                                 [175 + index * 280, pic_y + 89])
                if song_fc != None:
                    base = generate_tool.simple_draw(base, f"./assets/img/mai/b50/sync/UI_RSL_{song_fc}_Text_01.png",
                                                     [47, 24], [203 + index * 280, pic_y + 87])
                if song_fs != None:
                    base = generate_tool.simple_draw(base, f"./assets/img/mai/b50/sync/UI_RSL_{song_fs}_Text_01.png",
                                                     [47, 24], [245 + index * 280, pic_y + 87])

            except IndexError:
                base = generate_tool.simple_draw(base, f"./assets/img/mai/b50/diff/mai-frame-empty.png", [282, 120],
                                                 [19 + index * 280, pic_y])
            count += 1
            index += 1
            song_no += 1
...
class mai_best50():
    ...
    def lxns(b50_info, player_data):
        ...
        b50_image = Image.open("./assets/img/mai/b50/mai-b50-bud.png")
        HanSans37_28 = ImageFont.truetype("./assets/font/SourceHanSans_37.ttf", size=28)
        HanSans37_16 = ImageFont.truetype("./assets/font/SourceHanSans_37.ttf", size=16)
        FotB_19 = ImageFont.truetype("./assets/font/FOT-RodinNTLGPro-B.otf", size=19)
        FotB_24 = ImageFont.truetype("./assets/font/FOT-RodinNTLGPro-B.otf", size=24)
        if player_frame_id != None:
            try:
                b50_image = generate_tool.simple_draw(b50_image,
                                                      f"./assets/img/mai/b50/frame/UI_Frame_{player_frame_id}.png",
                                                      [1440, 603], [0, 0])
            except FileNotFoundError:
                b50_image = generate_tool.simple_draw(b50_image,
                                                      f"./assets/img/mai/b50/frame/UI_Frame_000000.png",
                                                      [1440, 603], [0, 0])
        b50_image = generate_tool.simple_draw(b50_image, "./assets/img/mai/b50/Diving-Fish.png", [174, 24], [1188, 110])
        b50_image = generate_tool.simple_draw(b50_image, f"./assets/img/mai/b50/plate/UI_Plate_{player_plate_id}.png",
                                              [960, 155], [40, 40])
        b50_image = generate_tool.simple_draw(b50_image, f"./assets/img/mai/b50/icon/UI_Icon_{player_icon_id}.png",
                                              [131, 131], [52, 52])
        ra_bg_index = generate_tool.return_ra_bg(dxRating)
        b50_image = generate_tool.simple_draw(b50_image,
                                              f"./assets/img/mai/b50/rating/UI_CMN_DXRating_{ra_bg_index}.png",
                                              [226, 44], [190, 50])
        ...
        b50_image = generate_tool.simple_draw(b50_image, "./assets/img/mai/b50/playername.png", [386, 78], [178, 87])
        draw_nickname = ImageDraw.Draw(b50_image)
        draw_nickname.text((203, 100), player_name, (0, 0, 0), HanSans37_28)
        b50_image = generate_tool.simple_draw(b50_image,
                                              f"./assets/img/mai/b50/course/UI_CMN_DaniPlate_{player_course_rank}.png",
                                              [104, 48], [437, 98])
        b50_image = generate_tool.simple_draw(b50_image,
                                              f"./assets/img/mai/b50/trophy/UI_CMN_Shougou_{player_trophy_color}.png",
                                              [368, 48], [185, 145])
        ...
        #计算居中后的X值
        draw_trophy.text([trophy_x, 153], player_trophy_name, (255, 255, 255), HanSans37_16, stroke_width=1,
                         stroke_fill=(0, 0, 0))
        b50_image = generate_tool.simple_draw(b50_image, "./assets/img/mai/b50/ratingtable.png", [814, 325], [40, 240])
