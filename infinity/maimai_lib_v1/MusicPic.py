...
from .tool import wrap_text, truncate_text, get_cover_len6_id, image_path_to_base64

MusicPic = rf"./assets/img/mai/pic"
Font_path = rf"./assets/font"
MusicCover = rf"./assets/img/mai/cover"
...
async def music_info_pic(music: Music) -> str:
    ...
    msg = MessageSegment.image(image_path_to_base64(byte_data))
    return msg
