...
from .class_utils import UserData,ChartInfo
from .tool import truncate_text
...
class DrawBest(object):
    def __init__(self, userData:UserData,mode="落雪"):
        ...
        self.pic_dir = './assets/img/chu/b30/'
        self.cover_dir = './assets/cover/chu'
        self.font_dir = './assets/font/'
