...
# path
today_path = r"./assets/img/today/"
user_path = r"./cache/user/"


class FortuneManager:
    def __init__(self):
        self._user_data: Dict[str, Dict[str, Union[str, int, date]]] = dict()
        self._user_data_file: Path = Path(user_path + "fortune_data.json")
    ...
    def divine(self, uid: str) -> Tuple[bool, Union[Path, None]]:
        ...
        if not self._multi_divine_check(uid, now_time):
            ...
            img_path: Path = Path(user_path + f"user_{uid}.png")
