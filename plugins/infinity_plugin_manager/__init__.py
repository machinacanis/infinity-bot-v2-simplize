...
from infinity import add_whitelist_qq_group, remove_whitelist_qq_group, add_banned_qq_user, get_instance_qid, \
    message_occurred, update_whitelist_and_banned_list
